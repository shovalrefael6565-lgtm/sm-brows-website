...
export const PRIVACY_NOTICE_UPDATED = 'ספטמבר 2026'
...
export const BOOKING_PRIVACY_NOTICE =
  ...
  'מספר הטלפון עשוי לשמש למשלוח הודעות שירות באמצעות 019 SMS. ' +
  'סימון אישור הדיוור הוא רשות ואינו תנאי לקביעת התור; אם יסומן, מספר הטלפון ישמש גם ' +
  'למשלוח עדכונים והטבות באמצעות 019 SMS, וניתן להסיר את ההסכמה בכל עת. ' +
  'ניתן לבקש לעיין במידע או ' +
...
/**
 * נוסח checkbox הדיוור השיווקי בטופסי ההזמנה (ציבורי + אזור אישי).
 *
 * 🔒 **אופציונלי לחלוטין, ולא מסומן מראש.** אינו תנאי לקביעת תור, אינו
 * נבדק ב-validateFinal/canSubmit, ואינו יכול להכשיל בקשה. checkbox שני
 * ונפרד — אין לאחד אותו עם PRIVACY_ACK_LABEL ואין לגזור אחד מהשני:
 * האישור שם הוא acknowledgement של קריאה, וכאן זו הסכמה אקטיבית לדיוור.
 *
 * ⚠️ אינו נוגע בתזכורות, בהודעות שירות וב-OTP. "תזכורות לקביעת תורים"
 * כאן היא הזמנה שיווקית לקבוע תור חדש — לא תזכורת לתור קיים, שממשיכה
 * להישלח בלי קשר להסכמה הזו ובלי קשר להסרה מדיוור.
 */
