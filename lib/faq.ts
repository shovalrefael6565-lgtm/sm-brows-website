  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'כן, אני מציעה צביעת גבות (henna / צבע כימי) כחלק מטיפול עיצוב גבות מקיף. עמידות הצבע משתנה בין לקוחה ללקוחה ותלויה בסוג השערה, בסוג העור ובשגרת הטיפוח. ברוב המקרים הצבע דוהה בהדרגה ויכול להחזיק עד שבועיים.',
      },
    ],
  },
  {
