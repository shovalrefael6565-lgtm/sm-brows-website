...
export const ADMIN_ERROR_MESSAGES: Record<string, string> = {
  ...
  // ── 15I: המועד מגיע מהיומן ──
  adopt_not_supported:  'קישור לאירוע קיים ביומן זמין למיקרובליידינג ולייעוץ מיקרובליידינג בלבד.',
  adopt_event_invalid:  'לא ניתן לגזור מועד מהאירוע שנבחר. יש לבחור אירוע עם שעת התחלה וסיום ומשך של 5 עד 480 דקות.',
