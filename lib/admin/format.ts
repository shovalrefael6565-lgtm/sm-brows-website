...
export const ADMIN_ERROR_MESSAGES: Record<string, string> = {
  ...
  // ── 15I: המועד מגיע מהיומן · 15J: לכל טיפול ידני ──
  adopt_not_supported:  'הטיפול שנבחר אינו טיפול שאפשר לקבוע ידנית, ולכן אין לאן לקשר את האירוע.',
  adopt_event_invalid:  'לא ניתן לגזור מועד מהאירוע שנבחר. יש לבחור אירוע עם שעת התחלה ושעת סיום — אירוע "יום שלם" אינו יכול להיות תור.',
  adopt_event_duration: 'משך האירוע ביומן חורג ממה שאפשר לשמור כתור — 5 עד 480 דקות.',
  calendar_time_locked: 'המועד של התור הזה נקבע ביומן Google, ולכן אי אפשר לשנות אותו כאן. יש להזיז את האירוע ביומן, והשינוי יסתנכרן למערכת.',
  start_in_past:        'לא ניתן לקבוע תור במועד שכבר עבר.',
  past:                 'האירוע שנבחר כבר התחיל או הסתיים. המערכת אינה יכולה לשמור תור במועד שעבר.',
  invalid_duration:     'משך הטיפול אינו תקין.',
  db_conflict:          'קיים כבר תור אחר במערכת בשעות האלה. שני תורים פעילים אינם יכולים לחפוף, ולכן צריך לבטל או להזיז את התור האחר לפני שאפשר לקשר את האירוע הזה.',
