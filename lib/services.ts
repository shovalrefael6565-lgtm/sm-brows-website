...
export const NATURAL_VARIANTS: NaturalVariant[] = [
  ...
  /*
    ⚠️ נוסח העמידות מיושר מול lib/faq.ts ומול המאמר /blog/eyebrow-tinting-guide:
    "עד שבועיים", בלי טווח מספרי נוסף. כאן הטקסט מקוצר כי הוא יושב בתוך
    כרטיס בחירה בטופס ההזמנה — המשמעות זהה, ואין להחזיר טווח אחר.
  */
  { id: 'עיצוב גבות + צביעה', label: 'עיצוב גבות + צביעה', desc: 'כולל צביעת גבות — הצבע דוהה בהדרגה ויכול להחזיק עד שבועיים', price: 85 },
