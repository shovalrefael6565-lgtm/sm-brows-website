...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      'עיצוב גבות מדויק ומקצועי המדגיש את יופי הפנים הטבעי. הטיפול כולל הגדרה מותאמת אישית לצורת הפנים ולמבנה הגבה, ומסתיים בצביעה מקצועית להעמקת הצבע הטבעי. אפקט הצביעה נמשך כ-7 עד 10 ימים.',
    price: '₪85',
    duration: '15–30 דקות',
    ...
    features: [
      ...
      'צביעת גבות לאיזון ועומק צבע',
      'אפקט הצביעה נמשך כ-7 עד 10 ימים',
    ],
  },
  {
    id: 'brow-lifting',
...
export const galleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    category: 'microblading',
    type: 'before-after',
    beforeImage: '/microblading-3.jpg',
    afterImage: '/microblading-4.jpg',
