 ...
 *
 * ⚠️ **24.09.2026: 30 → 37.** הורחב כדי שכל אוקטובר 2026 ייפתח להזמנה —
 * ב-24.09 יום 30 נפל על 24.10, ו-25–31.10 היו מוסתרים. 37 מביא בדיוק עד
 * 31.10.
 *
 * ⚠️ זהו חלון **מתגלגל**, לא תאריך סיום קבוע: הוא תמיד 37 יום מ*היום*, ולכן
 * ככל שהזמן מתקדם הוא ימשיך אל תוך נובמבר. אין כאן "עד 31.10" קשיח — הוספת
 * גבול כזה הייתה גייט חדש בלוגיקת הזמינות, ובמכוון לא נוסף.
 *
 * 🔒 חגים אינם מיוצגים בקוד — הם נסגרים אך ורק ע"י חסימה ביומן Google.
 * לכן הרחבה ל-37 יום מחייבת ששובל תחסום ביומן 37 יום קדימה, לא 30.
 */
export const BOOKING_HORIZON_DAYS = 37
