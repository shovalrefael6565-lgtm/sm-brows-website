...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'עד שנה, תלוי בסוג העור ואורח החיים. מומלץ טיפול חיזוק (touch-up) לאחר 6–8 שבועות מהטיפול הראשון.',
  },
  {
  ...
  },
  {
    ...
    a: 'תשלום במזומן, ביט, פייבוקס או כרטיס אשראי — בקליניקה לאחר הטיפול. למיקרובליידינג ניתן לפצל ל-2 תשלומים שווים.',
  },
  {
    q: 'איפה נמצאת הקליניקה?',
    a: 'הקליניקה נמצאת בעיר היין, אשקלון. את הכתובת המלאה תקבלי בוואצאפ יחד עם אישור התור.',
  },
]
