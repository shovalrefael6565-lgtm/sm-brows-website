      ...
      content: (
        <>
          <p>
            ...
            דין. <strong>נכון למועד עדכון מסמך זה, טרם נקבעה תקופת שמירה קבועה או מנגנון מחיקה אוטומטי
            מבוסס-זמן</strong>, ומחיקת מידע מתבצעת כיום באופן ידני ובכפוף לבדיקה מול הדין, הצורך העסקי
            וחובות השמירה הרלוונטיים. אני שוקלת לקבוע מדיניות שמירה מפורטת יותר בעתיד, ומסמך זה יעודכן
            בהתאם.
          </p>
          <p className="mt-3">
            לקודי האימות ולהפעלות הכניסה מוגדר תוקף שימוש מוגבל, ולאחר פקיעתו לא ניתן להשתמש בהם
            לצורך כניסה. נכון למועד עדכון מדיניות זו, הרשומות הטכניות הקשורות לניסיונות אימות
            ולהפעלות אינן נמחקות כולן באופן אוטומטי מבסיס הנתונים. תקופות שמירה ומנגנון ניקוי ייעודי
            ייקבעו במסגרת מדיניות השמירה של העסק.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          ...
          <ul className="list-disc list-inside space-y-2 text-brand-medium text-sm">
            ...
            <li><strong>ספק SMS (019)</strong> — לשליחת קוד כניסה חד-פעמי (OTP) ותזכורות תור.</li>
            <li>
