  ...
  const sections: Section[] = [
    {
      ...
      content: (
        <p>
          מדיניות פרטיות זו מתארת את האופן שבו {BUSINESS_NAME}, בבעלות {OWNER_NAME} (להלן: "הסטודיו" או "אני"),
          אוספת, משתמשת ושומרת על מידע אישי של משתמשי האתר ולקוחות הסטודיו, בהתאם לחוק הגנת הפרטיות,
          תשמ"א–1981 ותקנות הגנת הפרטיות (אבטחת מידע), תשע"ז–2017.
          השימוש באתר ו/או בטיפולי הסטודיו מהווה הסכמה למדיניות פרטיות זו.
        </p>
      ),
    },
    {
