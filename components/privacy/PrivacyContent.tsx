...
export default function PrivacyContent() {
  const sections: Section[] = [
    ...
    {
      id: 'collected-data',
      title: '2. המידע שאני אוספת',
      content: (
        <>
          <p className="mb-3">אני עשויה לאסוף את סוגי המידע הבאים:</p>
          ...
          <p className="mt-3 text-sm">אני לא אוספת מידע רגיש כהגדרתו בחוק (כגון מידע בריאותי, ביומטרי, דתי או פוליטי), אלא אם נמסר מרצון הלקוחה לצורך הכנת הטיפול.</p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc list-inside space-y-2 text-brand-medium text-sm">
            ...
            <li>משלוח עדכונים על מבצעים וטיפולים חדשים (בהסכמה בלבד)</li>
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          הכרחיות לביצוע הסכם שירות (לצורך מתן טיפול), ואינטרס לגיטימי של הקליניקה
      ...
      content: (
        <>
          <p>
            ...
            אני נוקטת אמצעי אבטחה טכניים וארגוניים סבירים להגנה על המידע מפני גישה
    ...
    },
    {
      ...
      content: (
        <>
          <p className="mb-3">
            אני לא מוכרת, משכירה או משתפת מידע אישי עם צדדים שלישיים למטרות שיווקיות.
          ...
          <ul className="list-disc list-inside space-y-2 text-brand-medium text-sm">
            ...
            <li><strong>הגנה על זכויות:</strong> במקרה הכרחי להגנה על זכויות הקליניקה או על בטיחות הציבור</li>
          </ul>
        </>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <p>
          שירותי הקליניקה מיועדים לבני 16 ומעלה. קטינים מתחת לגיל 16 נדרשים לקבל הסכמת הורה
    ...
    },
    {
      ...
      content: (
        <p>
          אני שומרת לעצמי את הזכות לעדכן מדיניות פרטיות זו מעת לעת.
