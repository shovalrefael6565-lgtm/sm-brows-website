...
const FAQ_DATA: FaqSection[] = [
    ...
    items: [
      {
        ...
        a: 'מיקרובליידינג הוא טיפול קוסמטי חצי-קבוע שבו מצוירות שיערות דקות בצבע על עור הגבה בעזרת סכין ידנית מיוחדת. התוצאה היא גבות טבעיות, מלאות ומוגדרות שמחזיקות 12–24 חודשים.',
      },
      {
      ...
      },
      {
        ...
        a: 'התוצאה מחזיקה בין 12 ל-24 חודשים, תלוי בסוג העור, אורח חיים וחשיפה לשמש. מומלץ לבצע טיפול חיזוק (touch-up) לאחר 6–8 שבועות מהטיפול הראשון.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'האם יש צביעת גבות בסטודיו?',
        a: 'כן, אנו מציעות צביעת גבות (henna / צבע כימי) כחלק מטיפול עיצוב גבות מקיף. הצבע מחזיק 2–4 שבועות תלוי בסוג הצבע ובטיפול.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'הטיפול בטוח כשהוא מבוצע נכון. אנו משתמשות במוצרים איכותיים ומוסמכים. ההמלצה היא לא לחזור על הטיפול לפני שחלפו 6 שבועות מהפעם הקודמת, ולטפח את השיערות בשמן קסטור.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'האם הקורס מוכר?',
        a: 'תעודת ההסמכה מוכרת על ידי הסטודיו ומהווה אסמכתא לאיכות ומקצועיות. לצורך רישיון עסק עצמאי, יש לפנות לרשויות המקומיות הרלוונטיות.',
      },
    ],
  },
  {
    ...
    items: [
      {
        q: 'כיצד קובעים תור?',
        a: 'ניתן לקבוע תור דרך וואצאפ או דרך מערכת קביעת התורים באתר. אנחנו מאשרות כל תור באופן אישי.',
      },
      {
        q: 'מה אמצעי התשלום המקובלים?',
        a: 'אנו מקבלות תשלום במזומן, בביט, ובפייבוקס. התשלום מתבצע בסטודיו לאחר הטיפול.',
      },
      {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="mt-12 bg-brand-rose-bg rounded-3xl p-8 border border-brand-rose-light text-center">
          ...
          <p className="text-brand-medium text-sm mb-5">
            שלחי לנו הודעה בוואצאפ ונשמח לעזור
          </p>
          <a
            href={WHATSAPP_URL}
            target="_blank"
