      ...
      */}
      <div className="flex flex-col-reverse lg:grid lg:grid-cols-[0.46fr_0.54fr] lg:min-h-[680px]">
        ...
        >
          ...
          {/*
            ⚠️ שורת הייחוס היחידה באתר שבה השם המלא מופיע כטקסט HTML.

            עד ROUND B "שובל מאירה" לא הופיע באף עמוד — לא בגוף הבית, לא
            ב-/services ולא ב-/course (רק ב-meta description ובתכונת alt
            אחת). כלומר לשאלה "מי מעצבת הגבות באשקלון" לא הייתה באתר שום
            תשובה שאפשר לקרוא או לצטט, וזה גם חור E-E-A-T וגם חור GEO.

            מיקומה כאן ולא ב-section חדש: זהו הבלוק של המיקרובליידינג —
            ההתמחות שלה — ולכן זה המקום היחיד שבו המשפט נקרא כהמשך טבעי
            של הטקסט ולא כקורות חיים שהודבקו. הסגנון זהה לפסקה שמעליה
            (text-white/50), רק עם קו מפריד עדין; אין כאן אלמנט עיצובי חדש.

            ⚠️ חמש השנים וההתמחות הן העובדות שאושרו — ותו לא. אין להוסיף
            כאן היכן למדה, תעודות, הסמכות או פרסים.
          */}
          <p className="text-white/40 text-sm leading-relaxed mb-10 ps-4 border-s border-white/15">
            מאחורי כל טיפול עומדת <strong className="font-semibold text-white/70">שובל מאירה</strong>,
            מייסדת S.M BROWS — חמש שנים בעולם הגבות, עם התמחות מיוחדת במיקרובליידינג,
            בקליניקה שבעיר היין, אשקלון.
          </p>
