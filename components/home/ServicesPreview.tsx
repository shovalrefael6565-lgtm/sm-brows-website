              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <a
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-brand-gold text-brand-dark font-semibold text-sm py-3 rounded-xl hover:bg-brand-gold-dark transition-colors duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold"
                  >
                    <WhatsAppSmIcon />
                    קבעי תור בוואצאפ
                  </a>
