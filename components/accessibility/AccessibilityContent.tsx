        ...
        {[
          {
            ...
            content: (
              <p>
                אני מחויבת לאפשר לאנשים עם מוגבלות לגלוש באתר ולהשתמש בטיפולים
                בצורה שוויונית ומכובדת. אני עובדת לעמוד בדרישות תקן ישראלי 5568 ברמה AA,
          ...
          },
          {
            ...
            content: (
              <p>
                ...
                אני ממשיכה לשפר את הנגישות ולהתאים את האתר לדרישות תקן זה.
              </p>
            ),
          },
          {
            ...
            content: (
              <>
                <p className="mb-3 text-sm text-brand-medium">
                  למרות מאמצי, קיימות מגבלות ידועות שאני עובדת לפתור:
                </p>
          ...
          },
          {
            ...
            content: (
              <p>
                ...
                אנא פני אלי דרך הדואר האלקטרוני או הוואצאפ. אשתדל לספק מענה תוך 5 ימי עסקים.
              </p>
            ),
          },
          {
          ...
          },
          {
            ...
            content: (
              <p>
                ...
                אני מעדכנת הצהרה זו אחת לשנה לפחות, ובכל עת שמבוצעים שינויים מהותיים באתר.
              </p>
            ),
          },
        ].map((section, i) => (
        ...
        <div className="mt-10 bg-brand-rose-bg rounded-3xl p-6 border border-brand-rose-light flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-brand-medium text-sm mb-3">
              אני מחויבת לשפר את חוויית הגלישה לכולם. צרי קשר ואשמח לעזור.
            </p>
            <Link
              href="/contact"
